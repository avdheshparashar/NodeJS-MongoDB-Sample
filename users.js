        ...
        db.collection('pendingusers', function (err, collection) {
            ...
            collection.insert(fields, {safe: true}, function (err, result) {
                ...
                if (err) {
                    ...
                    var mailOptions = {
                        from: "Some Guy", // sender address
                        to: result[0].email, // list of receivers
                        subject: "Thank you", // Subject line
                        text: "Thank you for registering to this Mobile Application. Please click below link to complete 													the process" + '\n' +
                            "http://some_URL/account/email/confirm/" + result[0]._id + "/" + uuid.v4()
...
exports.coverImage = function(req, res){
    ...
    var form = new formidable.IncomingForm({uploadDir: '/home/public/img/coverimage/', keepExtensions:true});
                                      ...
                                      function(err, user){
                                            ...
                                            if(typeof files.image !== "undefined"){
                                                ...
                                                if(typeof user.coverimage !== "undefined"){
                                                    fs.unlink('/home/public/img/coverimage/'+ user.coverimage, function(err){
                                                        if(err){
...
exports.imageTest = function(req, res){
    ...
    gm('/home/public/img/7ba1520029448805b4538fb34dc078fa.jpg')
                .resize(72, 72)
                .noProfile()
                .write('/home/public/img/7ba1520029448805b4538fb34dc078fa.jpg', function (err) {
                  if (!err) {
                        console.log('done');
			res.send(true);
                    }else{
...
exports.profileImage = function(req, res){
    ...
    var form = new formidable.IncomingForm({uploadDir: '/home/public/img/', keepExtensions:true});
            ...
            userCollection.findOne({"_id": new BSON.ObjectID(user_id)},
                                      ...
                                      function(err, user){
                                            ...
                                            if(typeof files.image !== "undefined"){
                                                ...
                                                var old_image = '/home/public/img/'+ user.image;
                                                fields['image'] = files.image.path.substring(files.image.path.lastIndexOf("/")+1);
                    ...
                    db.collection('users', function(err, collection) {
                        collection.update({'email':email},{$set:{"password":newpassword}},function(err) {
                           if(err) {
                                ...
                                var mailOptions = {
                                    from: "Some Guy", // sender address
                                    to: 'Some Other GUy Emmail', // list of receivers
